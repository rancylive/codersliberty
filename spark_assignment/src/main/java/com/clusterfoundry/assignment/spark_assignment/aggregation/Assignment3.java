...
public class Assignment3 {
    public static void main( String[] args )
    {
        ...
        Dataset result = sparkSession.sql("select gd.sqldate from csv.gdelt2 gd inner join (select monthyear,count(globaleventid) as gc from csv.gdelt2 group by monthyear sort by gc desc limit 1) as gdd on gdd.monthyear=gd.monthyear limit 10");
